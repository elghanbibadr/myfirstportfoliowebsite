...
const Hero = () => {
  ...
  return (
    <section className='hero my-20  md:grid items-center grid-cols-2' >
      <h1 className='text-2xl text-center font-bold leading-10 md:text-5xl md:text-left'>
      ...
      <motion.div
        ...
        className='w-3/4 mt-10 mx-auto imgWrraper flex justify-center rounded-md lg:w-1/2 '>
